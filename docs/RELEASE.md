...
5. Confirm npm installation, provenance, documentation links, all examples, three browser engines, `version.json`, and production security headers.
...
- Chromium, Firefox, and WebKit rendering/playground tests, axe checks, and narrow-layout smoke.
- Fresh npm and pnpm tarball consumers with TypeScript resolution.
- Public API snapshot, generated command/diagnostic/conformance docs, strict publint, package contents, license policy, production audit, and tag/version equality.
- Gzip budgets: Node 225 KiB, web 260 KiB, pre-interaction playground JavaScript 650 KiB including the automatically loaded renderer. Monaco must stay asynchronous.
...
- No high or critical production vulnerability.
